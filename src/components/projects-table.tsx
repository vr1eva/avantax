...
export const columns: ColumnDef<Project>[] = [
    ...
    {
        accessorKey: "snipCode",
        header: "Código SNIP",
        cell: ({ row }) => (
            <div className="capitalize">{row.getValue("snipCode")}</div>
        ),
    },
    {
        accessorKey: "name",
    ...
    },
    {
        ...
        header: "Monto de inversión referencial (en S/. M)",
        cell: ({ row }) => (
            <div className="capitalize">{row.getValue("investment")}</div>
        ),
    },
    {
        accessorKey: "ciprlMax",
    ...
    return (
        <div className="w-full">
            <div className="flex items-center py-4">
                <Input
                    placeholder="Filtrar proyecto por nombre"
