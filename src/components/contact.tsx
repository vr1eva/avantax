...
export default function Contact() {
    ...
    const classNames = {
        contact: ` flex flex-col mt-[40px] md:mt-[125px] mx-auto mb-[175px] w-full md:max-w-[878px]`,
        contactModal: `px-[15px] pb-[35px] md:py-6 md:px-5 rounded-[30px] max-w-[878px] bg-light xl:p-[65px]`,
